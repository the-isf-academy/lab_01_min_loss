...
💻 **TODO:** Your goal for this lab is to design ans write a function to help you find a good line with the lowest possible loss.
...
separate the creation of the plot from the dynamic updates. Plot size stays the same throughout but students will have to scroll up to see the plot (thus missing some/all of the animation) and my not know where to see the plot.
